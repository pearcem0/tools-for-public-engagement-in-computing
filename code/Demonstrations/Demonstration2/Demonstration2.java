...
public class Demonstration2 extends java.applet.Applet 
{  
  ...
  */
   ...
   // Image img = ImageIO.read(new File("background.jpg"));
    ...
    {   
        ...
        Demonstration2 graph = new Demonstration2();
...
{
    JTextField titleField = new JTextField("Shortest Path Problem - Demonstration 2");
    
    Title(Demonstration2 myparent)
    {
...
class Buttons extends Panel 
{
    ...
    Demonstration2 parent;   

    Buttons(Demonstration2 myparent) 
    { /*
...
class GraphCanvas extends Canvas implements Runnable 
{
    ...
    GraphCanvas(Demonstration2 myparent) 
    {
	  parent = myparent;
	   ...
	   for (int i=0; i<numnodes; i++)
	      if (finaldist[i] > 0)
	      {
           ...
           parent.infoText.append("Finished. \n" + 
            	    "The shortest path is via : A B D C F\n"); 

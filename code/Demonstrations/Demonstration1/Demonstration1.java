...
public class Demonstration1 extends java.applet.Applet
{
  ...
  */
   ...
   // Image img = ImageIO.read(new File("background.jpg"));
    ...
    public static void main(String arg[])
    {
        ...
        Demonstration1 graph = new Demonstration1();
...
{
    JTextField titleField = new JTextField("Shortest Path Problem - Demonstration 1");

    Title(Demonstration1 myparent)
    {
...
class Buttons extends Panel
{
    ...
    Demonstration1 parent;

    Buttons(Demonstration1 myparent)
    { /*
...
class GraphCanvas extends Canvas implements Runnable
{
    ...
    GraphCanvas(Demonstration1 myparent)
    {
	  parent = myparent;

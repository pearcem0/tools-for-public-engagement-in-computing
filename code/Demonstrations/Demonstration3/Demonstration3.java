...
public class Demonstration3 extends java.applet.Applet 
{  
  ...
  */
   ...
   // Image img = ImageIO.read(new File("background.jpg"));
    ...
    {   
        ...
        Demonstration3 graph = new Demonstration3();
...
{
    JTextField titleField = new JTextField("Shortest Path Problem - Demonstration 3");
    
    Title(Demonstration3 myparent)
    {
...
class Buttons extends Panel 
{
    ...
    Demonstration3 parent;   

    Buttons(Demonstration3 myparent) 
    { /*
...
class GraphCanvas extends Canvas implements Runnable 
{
    ...
    GraphCanvas(Demonstration3 myparent) 
    {
	  parent = myparent;
	   ...
	   for (int i=0; i<numnodes; i++)
	      if (finaldist[i] > 0)
	      {
           ...
           parent.infoText.append("Finished. \n" + 
            	    "The shortest path is via : A D F H\n"); 

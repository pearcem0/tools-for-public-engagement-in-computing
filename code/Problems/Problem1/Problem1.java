...
public class Problem1 extends java.applet.Applet
{  
   ...
   public static int[] nodesHit = new int[5];
   /*
...
class GraphCanvas extends Canvas implements Runnable 
{
 ...
 w=this.size().width/8;
    ...
    {  j = i;
	  if ( (x-node[i].x)*(x-node[i].x) + 
				...
				(y-node[i].y)*(y-node[i].y) < dist*dist ) 
                {
	              ...
	              hitnode = i;
                  Problem1.nodesHit[Problem1.nodeHits]=hitnode;  
                  //nodesHit[Problem1.nodeHits]=hitnode;
                  
                  //System.out.println(Problem1.nodeHits);
   ...
   {
      int[] correctNodesHit = {1,2,4,0,0};
      int[] correctNodesHit2 = {0,1,2,4,0};
     // System.out.println("user array"); for(int d=0;d<5;d++){System.out.println(Problem1.nodesHit[d]);}
     // System.out.println(numnodes);
      boolean checkNodePath = Arrays.equals(Problem1.nodesHit, correctNodesHit);
      boolean checkNodePath2 = Arrays.equals(Problem1.nodesHit, correctNodesHit2);
